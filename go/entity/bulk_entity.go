...
type BulkEntity struct {
	name    string
	client  *core.BranchQuickLinksSDK
...
func NewBulkEntity(client *core.BranchQuickLinksSDK, entopts map[string]any) *BulkEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BulkEntity) GetName() string { return e.name }
...
func (e *BulkEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BulkEntity) Deleted() bool {
	return e.deleted
}


func (e *BulkEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBulkEntity(e.client, opts)
}

func (e *BulkEntity) Data(args ...any) any {
...
func (e *BulkEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Bulk; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BulkEntity) DataTyped(data ...Bulk) Bulk {
	if len(data) > 0 {
		return typedFrom[Bulk](e.Data(asMap(data[0])))
	}
	return typedFrom[Bulk](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Bulk (all fields
// optional at the wire level).
func (e *BulkEntity) MatchTyped(match ...Bulk) Bulk {
	if len(match) > 0 {
		return typedFrom[Bulk](e.Match(asMap(match[0])))
	}
	return typedFrom[Bulk](e.Match())
}
...
func (e *BulkEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BulkEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *BulkEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *BulkEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BulkCreateData and returns an Bulk. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *BulkEntity) CreateTyped(reqdata BulkCreateData, ctrl map[string]any) (Bulk, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Bulk{}, err
	}
	return typedFrom[Bulk](res), nil
}



func (e *BulkEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BulkEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BulkEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
