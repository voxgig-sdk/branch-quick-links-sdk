...
func NewUrlEntity(client *core.BranchQuickLinksSDK, entopts map[string]any) *UrlEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UrlEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *UrlEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *UrlEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UrlCreateData and returns an Url. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *UrlEntity) CreateTyped(reqdata UrlCreateData, ctrl map[string]any) (Url, error) {
...
func (e *UrlEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// UrlUpdateData and returns an Url. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *UrlEntity) UpdateTyped(reqdata UrlUpdateData, ctrl map[string]any) (Url, error) {
