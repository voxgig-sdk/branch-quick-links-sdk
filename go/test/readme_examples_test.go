...
const testSeed = `map[string]any{"entity": map[string]any{"bulk": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "url": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
