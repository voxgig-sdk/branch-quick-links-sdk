...
func registerSDKWords(r *eng.Registry, client *sdk.BranchQuickLinksSDK) {
...
func runOp(client *sdk.BranchQuickLinksSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
