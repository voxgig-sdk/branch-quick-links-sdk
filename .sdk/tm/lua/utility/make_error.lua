...
local function make_error_util(ctx, err)
  ...
  local msg = "BranchQuickLinksSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = BranchQuickLinksError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == BranchQuickLinksError then
