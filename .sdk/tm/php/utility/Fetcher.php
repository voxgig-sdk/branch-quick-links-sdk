...
// BranchQuickLinks SDK utility: fetcher

class BranchQuickLinksFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BranchQuickLinksSDK/1.0)';
    ...
    public static function call(BranchQuickLinksContext $ctx, string $fullurl, array $fetchdef): array
    {
