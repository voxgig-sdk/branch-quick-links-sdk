...
// BranchQuickLinks SDK utility: graphql
//
...
class BranchQuickLinksGraphql
{
    ...
    // equivalent.
    public static function body(BranchQuickLinksContext $ctx): mixed
    {
    ...
    public static function errors(BranchQuickLinksContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
