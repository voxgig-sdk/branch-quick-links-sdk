...
// BranchQuickLinks SDK utility: make_options

class BranchQuickLinksMakeOptions
{
    ...
    public static function call(BranchQuickLinksContext $ctx): array
    {
        ...
        //
        // `BranchQuickLinksSchema::optspec()` is built from the model:
        ...
        $optspec = BranchQuickLinksSchema::optspec();
