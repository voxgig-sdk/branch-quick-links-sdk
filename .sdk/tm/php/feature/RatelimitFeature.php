...
// BranchQuickLinks SDK ratelimit feature
...
class BranchQuickLinksRatelimitFeature extends BranchQuickLinksBaseFeature
{
    ...
    private function _acquire(BranchQuickLinksContext $ctx): void
    {
    ...
    private function _track(BranchQuickLinksContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
