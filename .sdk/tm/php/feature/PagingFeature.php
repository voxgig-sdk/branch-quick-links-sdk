...
// BranchQuickLinks SDK paging feature
...
class BranchQuickLinksPagingFeature extends BranchQuickLinksBaseFeature
{
    ...
    private function _graphql_pre_request(BranchQuickLinksContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(BranchQuickLinksContext $ctx): bool
    {
