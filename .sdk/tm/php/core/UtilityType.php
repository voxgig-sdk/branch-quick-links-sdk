...
// BranchQuickLinks SDK utility type

class BranchQuickLinksUtility
{
    ...
    public static function copy(BranchQuickLinksUtility $src): BranchQuickLinksUtility
    {
        $u = new BranchQuickLinksUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
