...
|---|---|---|
| `js/` | @voxgig-sdk/branch-quick-links-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/branch-quick-links | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/branch-quick-links-js \
      --repository voxgig-sdk/branch-quick-links-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/branch-quick-links-js` shows it, and
`npm trust revoke @voxgig-sdk/branch-quick-links-js --id=<id>` removes it.
