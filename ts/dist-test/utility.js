...
function envOverride(m) {
    if ('TRUE' === process.env.BRANCH_QUICK_LINKS_TEST_LIVE ||
        'TRUE' === process.env.BRANCH_QUICK_LINKS_TEST_OVERRIDE) {
    ...
    m.BRANCH_QUICK_LINKS_TEST_EXPLAIN = process.env.BRANCH_QUICK_LINKS_TEST_EXPLAIN || m.BRANCH_QUICK_LINKS_TEST_EXPLAIN;
    return m;
}
