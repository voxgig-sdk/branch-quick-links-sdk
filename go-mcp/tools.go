...
type Args struct {
	Entity string         `json:"entity" jsonschema:"bulk | url"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BranchQuickLinksSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "branch-quick-links_list",
		Description: "List records from BranchQuickLinks. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "branch-quick-links_load",
		Description: "Load a single record from BranchQuickLinks. " +
...
func runOp(client *sdk.BranchQuickLinksSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BranchQuickLinksSDK, name string) (sdk.BranchQuickLinksEntity, error) {
