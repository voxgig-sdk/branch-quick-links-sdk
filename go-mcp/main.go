// Command BranchQuickLinks-mcp is an MCP server exposing the BranchQuickLinks
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BranchQuickLinks_list  — list records of an entity
//	BranchQuickLinks_load  — load a single record of an entity
//
