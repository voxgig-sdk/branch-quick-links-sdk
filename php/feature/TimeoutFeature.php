...
// BranchQuickLinks SDK timeout feature
...
class BranchQuickLinksTimeoutFeature extends BranchQuickLinksBaseFeature
{
    ...
    private function _with_timeout(BranchQuickLinksContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BranchQuickLinksContext $_ctx, float $ms): void
    {
        $client = $this->client;
