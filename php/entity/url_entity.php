...
// BranchQuickLinks SDK Url entity
...
class UrlEntity
{
     ...
     * Create a new Url.
     *
     * @param UrlCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UrlCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Url|array The created Url as an assoc-array at the
     ...
     *
     * @param UrlUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UrlUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Url|array The updated Url as an assoc-array at the
     *   SDK boundary; throws BranchQuickLinksError on failure (item-5 convention).
     */
