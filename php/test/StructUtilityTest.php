...
// BranchQuickLinks SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BranchQuickLinksOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BranchQuickLinksOmni::structfix($now, Struct::undef()))
                        !== json_encode(BranchQuickLinksOmni::structfix($val, Struct::undef()))) {
