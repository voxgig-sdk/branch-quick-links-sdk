...
// BranchQuickLinks SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BranchQuickLinksSDK::test)
...
{
    private const SDK_CLASS = 'BranchQuickLinksSDK';
    ...
    private const SDK_BASE = 'branchquicklinks_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../branchquicklinks_sdk.php';
