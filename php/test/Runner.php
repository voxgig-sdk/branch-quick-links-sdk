...
class BranchQuickLinksTestRunner
{
    ...
    {
        $live = self::getenv('BRANCH_QUICK_LINKS_TEST_LIVE');
        $override = self::getenv('BRANCH_QUICK_LINKS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('BRANCH_QUICK_LINKS_TEST_EXPLAIN');
...
class_alias('BranchQuickLinksTestRunner', 'Runner');
class_alias('BranchQuickLinksHelpers', 'Helpers');
