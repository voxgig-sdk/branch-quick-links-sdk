...
// BranchQuickLinks SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class BranchQuickLinksParam
{
    public static function call(BranchQuickLinksContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = BranchQuickLinksHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
