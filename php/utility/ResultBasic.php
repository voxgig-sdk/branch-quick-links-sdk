...
// BranchQuickLinks SDK utility: result_basic

class BranchQuickLinksResultBasic
{
    public static function call(BranchQuickLinksContext $ctx): ?BranchQuickLinksResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof BranchQuickLinksError) ? $result->err->msg : (string)$result->err;
