# BranchQuickLinks SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BranchQuickLinksSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BranchQuickLinksSDK(...) and BranchQuickLinksSDK.test(...) become
#      BranchQuickLinksSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "branchquicklinks_sdk"
_SDK_CLASS = "BranchQuickLinksSDK"
