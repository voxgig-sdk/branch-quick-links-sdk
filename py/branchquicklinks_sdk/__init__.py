...
from branchquicklinks_sdk.utility import register

# Load features
from branchquicklinks_sdk.feature.base_feature import BranchQuickLinksBaseFeature
from branchquicklinks_sdk.features import _has_feature, _make_feature
...
class BranchQuickLinksSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = BranchQuickLinksUtility()
        self._utility = utility

        from branchquicklinks_sdk.config import shared_config
    ...
    def get_utility(self):
        return BranchQuickLinksUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BranchQuickLinksSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Bulk(self, data=None) -> "BulkEntity":
        ...
        from branchquicklinks_sdk.entity.bulk_entity import BulkEntity
        return BulkEntity(self, data)


    def Url(self, data=None) -> "UrlEntity":
        """Entity factory: client.Url().list() / client.Url().load({"id": ...})."""
        from branchquicklinks_sdk.entity.url_entity import UrlEntity
        return UrlEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "BranchQuickLinksSDK":
        if sdkopts is None:
            sdkopts = {}
