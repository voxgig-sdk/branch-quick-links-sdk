...
from branchquicklinks_sdk.branchquicklinks_types import (
    Bulk,
    BulkCreateData,
)
...
class BulkEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BulkEntity(self._client, opts)
    ...
    def create(self, reqdata: BulkCreateData, ctrl=None) -> Bulk:
        utility = self._utility
