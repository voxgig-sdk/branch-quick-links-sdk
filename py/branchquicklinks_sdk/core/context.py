...
from branchquicklinks_sdk.core.control import BranchQuickLinksControl
...
from branchquicklinks_sdk.core.helpers import get_ctx_prop, to_map
...
class BranchQuickLinksContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BranchQuickLinksControl()
        ...
        if isinstance(sp, BranchQuickLinksSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BranchQuickLinksResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BranchQuickLinksResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return BranchQuickLinksOperation({})
    ...
    def make_error(self, code, msg):
        return BranchQuickLinksError(code, msg, self)
